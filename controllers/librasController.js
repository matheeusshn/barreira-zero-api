class librasController {
    ...
    frasesEducacionais(req, res) {
        res.json({
            frases: [
                {
                    portugues: "Bom dia, turma!",
                    libras: "https://mock.barreirazero.com/libras/bom-dia.mp4"
                },
                {
                    portugues: "Vamos aprender matemática.",
                    libras: "https://mock.barreirazero.com/libras/matematica.mp4"
                }
            ]
        });
    }
